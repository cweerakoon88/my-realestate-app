    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-title { font-family: var(--serif); font-size: clamp(3rem, 5vw, 5rem); font-weight: 300; line-height: 1.05; color: var(--ink); margin-bottom: 1.5rem; }
        ...
        .btn-secondary { font-family: var(--sans); font-size: 13px; font-weight: 400; color: var(--ink-light); text-decoration: none; display: flex; align-items: center; gap: 8px; transition: color 0.2s; }
      ...
      <section className="section" id="how-it-works">
        ...
        <div className="steps">
          <div className="step"><div className="step-number">01</div><div className="step-icon">📋</div><h3 className="step-title">Post your requirement</h3><p className="step-desc">Tell us your ideal suburb, property type, number of bedrooms, and your budget. Takes less than 2 minutes.</p></div>
          <div className="step"><div className="step-number">02</div><div className="step-icon">🔍</div><h3 className="step-title">Sellers browse & match</h3><p className="step-desc">Property owners and agents in your target area see your requirement. If their property fits, they reach out with an offer.</p></div>
          <div className="step"><div className="step-number">03</div><div className="step-icon">🤝</div><h3 className="step-title">Compare & connect</h3><p className="step-desc">Review offers from multiple sellers, compare properties, and connect directly with the ones that interest you most.</p></div>
        </div>
      </section>
      ...
      <section className="advantages">
        <div className="advantages-inner">
          ...
          <div className="advantages-grid">
            {[
              { n: 'i.', t: "You're in control", d: "Traditional property search means you chase listings. Here, sellers compete for your attention. You set the terms — suburb, size, price — and wait for offers to arrive." },
              { n: 'ii.', t: "Access off-market properties", d: "Many sellers don't want to list publicly. They're motivated but private. PropMatch connects you to properties that never hit Domain or realestate.com.au." },
              { n: 'iii.', t: "Know what's fair", d: "Our built-in suburb price guide shows you median prices, market trends, and recent sales before you post — so your budget is grounded in reality." },
              { n: 'iv.', t: "No more FOMO", d: "Stop losing weekends to open homes that don't match your needs. Post once and let the right properties come to you, on your schedule." },
              { n: 'v.', t: "Direct seller contact", d: "No middlemen inflating prices. Connect directly with sellers and negotiate without the pressure of auction environments or bidding wars." },
              { n: 'vi.', t: "Completely free for buyers", d: "Posting a requirement costs you nothing. Browse offers, compare properties, and connect with sellers — all at no cost to you." },
            ].map((a, i) => (
